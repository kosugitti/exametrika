...
The Exametrika package provides comprehensive test data engineering tools, implementing the methods described in Shojima (2022). Test data engineering analyzes test response patterns to understand item characteristics and classify respondents. 
...
Exametrika was originally developed and published as a Mathematica and Excel Add-in. For additional information, visit:
...
result.LDB <- LDB(
  ...
  adj_file = tmp_file  # Network structure file
)
