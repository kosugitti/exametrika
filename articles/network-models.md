...
> **Note**: Most examples in this vignette are shown with `eval=FALSE`
> to keep CRAN build times short. For full rendered output, see the
> [pkgdown
...
g
#> IGRAPH 689ff7e DN-- 5 5 -- 
#> + attr: name (v/c)
#> + edges from 689ff7e (vertex names):
